  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 backdrop-blur-sm bg-[#fafafa]/80 dark:bg-zinc-950/80 border-b border-transparent">
      ...
      <div className="hidden md:flex items-center gap-6 font-bold text-sm uppercase tracking-widest">
        ...
        <Button asChild className="font-bold border-2 border-black dark:border-zinc-200 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all bg-white text-black hover:bg-blue-50 dark:bg-zinc-900 dark:text-zinc-100 dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.5)] dark:hover:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.5)]">
