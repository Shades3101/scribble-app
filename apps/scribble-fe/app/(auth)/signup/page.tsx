            ...
            <div className="flex-1 flex items-center justify-center p-6 relative z-10">
                ...
                >
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="pt-2">
                                <Button
                                    variant="primary"
                                    size="lg"
                                    className="w-full italic text-lg shadow-[4px_4px_0px_0px_rgba(251,146,60,1)] hover:shadow-[2px_2px_0px_0px_rgba(251,146,60,1)]"
                    ...
                    <p className="mt-8 text-center text-[10px] font-bold uppercase tracking-[0.2em] text-[#2c2c2c]/30">
                        &copy; {new Date().getFullYear()} Scribble Inc.
                    </p>
                </motion.div>
            </div>
        </div>
